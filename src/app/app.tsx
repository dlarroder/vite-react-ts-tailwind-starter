    ...
    <main className={styles.main}>
      <header className={styles.header}>
        <h3 className={styles.headerTopTitle}>
          <span className={styles.headerTopTitleVital}>Vite Template</span>
        </h3>
      ...
      <section className={styles.copy}>
        <div className={styles.copyInner}>
          <a href="https://github.com/dlarroder/vite-react-ts-tailwind-starter">
            <Button>Visit on Github</Button>
          </a>
          <CopyButton text="git clone git@github.com:dlarroder/vite-react-ts-tailwind-starter.git" />
        </div>
      </section>
      ...
      <footer className={styles.footer}>
        <a href="https://github.com/jvidalv">
          Dale Larroder @ {new Date().getFullYear()}
        </a>
      </footer>
    </main>
  );
